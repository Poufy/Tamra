...
func TestMain(m *testing.M) {
	...
	if os.Getenv("CODEBUILD_BUILD_ID") != "" {
		...
		dbConnectionString = "postgresql://postgres:mysecretpassword@db:5433/tamra-postgis-test?sslmode=disable"
	} else {
		dbConnectionString = "postgresql://postgres:mysecretpassword@localhost:5433/tamra-postgis-test?sslmode=disable"
	}
